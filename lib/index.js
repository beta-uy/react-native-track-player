...
//  Beta - Fork
function resetTranscript(params) {
  return TrackPlayer.resetTranscript(params || {});
}

function finishTranscript() {
  return TrackPlayer.finishTranscript();
}

function finishAudioFile() {
  return TrackPlayer.finishAudioFile();
}
...
// Beta Fork
module.exports.resetTranscript = resetTranscript;
module.exports.finishTranscript = finishTranscript;
module.exports.eventEmitter = emitter;
module.exports.finishAudioFile = finishAudioFile;
